...
_lr_productions = [
  ...
  ('condition_factor -> condition_atom','condition_factor',1,'p_condition_factor_1','parser.py',134),
  ('condition_factor -> NEG condition','condition_factor',2,'p_condition_factor_2','parser.py',138),
  ('condition_factor -> LPAREN condition RPAREN','condition_factor',3,'p_condition_factor_3','parser.py',142),
  ('condition_term -> condition_factor AND condition_term','condition_term',3,'p_condition_term_1','parser.py',146),
  ('condition_term -> condition_factor','condition_term',1,'p_condition_term_2','parser.py',150),
  ('condition -> condition_term','condition',1,'p_condition_1','parser.py',154),
  ('condition -> condition_term OR condition','condition',3,'p_condition_2','parser.py',158),
  ('lhs -> ID LPAREN expression_list RPAREN','lhs',4,'p_lhs','parser.py',162),
  ('expression_list -> expression','expression_list',1,'p_expression_list_1','parser.py',168),
  ('expression_list -> expression COMMA expression_list','expression_list',3,'p_expression_list_2','parser.py',172),
]
